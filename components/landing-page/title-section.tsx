  ...
  return (
    <React.Fragment>
      <section className="flex flex-col gap-4 justify-center items-start md:items-center">
        <article className="rounded-full p-[1px] text-sm dark:bg-gradient-to-r dark:from-emerald-500 dark:to-rose-500">
        ...
        {subheading ? (
          <>
            ...
            <p className="dark:text-white/60 sm:max-w-[450px] md:text-center">
              {subheading}
            </p>
          </>
        ) : (
